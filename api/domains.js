...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('[Domains API] Token received:', token ? 'Yes' : 'No');
    
    const user = await verifyToken(token);
    console.log('[Domains API] User verified:', user ? user.id : 'No user');
    ...
    console.log('[Domains API] Is admin:', userIsAdmin, 'for user:', user.id);
